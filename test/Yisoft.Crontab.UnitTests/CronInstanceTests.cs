...
using Yisoft.Crontab.UnitTests.Extensions;
...
namespace Yisoft.Crontab.UnitTests
{
	...
	{
		private const string _TIME_FORMAT = "dd/MM/yyyy HH:mm:ss";
		...
		{
			var input = "* * * * *";
			var output = CrontabSchedule.Parse(input).ToString();
		...
		{
			Assert2.Throws<CrontabException>(() => CrontabSchedule.Parse("* * * *"));
			Assert2.Throws<CrontabException>(() => CrontabSchedule.Parse("* * * * * *"));
		...
		public void Formatting()
		{
			...
			foreach (var test in tests) Assert.AreEqual(test.outputString, CrontabSchedule.Parse(test.inputString, test.cronStringFormat).ToString());
		}
		...
		public void Evaluations()
		{
			var tests = new[]
			{
				...
				new
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "* * * * * *",
					nextOccurence = "01/01/2003 00:00:01",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:01",
					inputString = "* * * * * *",
					nextOccurence = "01/01/2003 00:00:02",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:02",
					inputString = "* * * * * *",
					nextOccurence = "01/01/2003 00:00:03",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:59",
					inputString = "* * * * * *",
					nextOccurence = "01/01/2003 00:01:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:01:59",
					inputString = "* * * * * *",
					nextOccurence = "01/01/2003 00:02:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 23:59:59",
					inputString = "* * * * * *",
					nextOccurence = "02/01/2003 00:00:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "31/12/2003 23:59:59",
					inputString = "* * * * * *",
					nextOccurence = "01/01/2004 00:00:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "28/02/2003 23:59:59",
					inputString = "* * * * * *",
					nextOccurence = "01/03/2003 00:00:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "28/02/2004 23:59:59",
					inputString = "* * * * * *",
					nextOccurence = "29/02/2004 00:00:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				new
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "45 * * * * *",
					nextOccurence = "01/01/2003 00:00:45",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
				...
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "45-47,48,49 * * * * *",
					nextOccurence = "01/01/2003 00:00:45",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:45",
					inputString = "45-47,48,49 * * * * *",
					nextOccurence = "01/01/2003 00:00:46",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:46",
					inputString = "45-47,48,49 * * * * *",
					nextOccurence = "01/01/2003 00:00:47",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:47",
					inputString = "45-47,48,49 * * * * *",
					nextOccurence = "01/01/2003 00:00:48",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:48",
					inputString = "45-47,48,49 * * * * *",
					nextOccurence = "01/01/2003 00:00:49",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:49",
					inputString = "45-47,48,49 * * * * *",
					nextOccurence = "01/01/2003 00:01:45",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
				...
				new
				{
					startTime = "01/01/2003 00:00:02",
					inputString = "2/5 * * * * *",
					nextOccurence = "01/01/2003 00:00:07",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:50",
					inputString = "2/5 * * * * *",
					nextOccurence = "01/01/2003 00:00:52",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:52",
					inputString = "2/5 * * * * *",
					nextOccurence = "01/01/2003 00:00:57",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:57",
					inputString = "2/5 * * * * *",
					nextOccurence = "01/01/2003 00:01:02",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
				...
				new
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:45:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:45:00",
					inputString = "45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:46:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:46:00",
					inputString = "45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:47:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:47:00",
					inputString = "45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:48:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:48:00",
					inputString = "45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:49:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:49:00",
					inputString = "45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 01:45:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				new
				{
					startTime = "01/01/2003 00:00:30",
					inputString = "3 45 * * * *",
					nextOccurence = "01/01/2003 00:45:03",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:30",
					inputString = "6 45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:45:06",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:45:30",
					inputString = "6 45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:46:06",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:46:30",
					inputString = "6 45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:47:06",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:47:30",
					inputString = "6 45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:48:06",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:48:30",
					inputString = "6 45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 00:49:06",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:49:30",
					inputString = "6 45-47,48,49 * * * *",
					nextOccurence = "01/01/2003 01:45:06",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:00:30",
					inputString = "9 2/5 * * * *",
					nextOccurence = "01/01/2003 00:02:09",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:02:30",
					inputString = "9 2/5 * * * *",
					nextOccurence = "01/01/2003 00:07:09",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:50:30",
					inputString = "9 2/5 * * * *",
					nextOccurence = "01/01/2003 00:52:09",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:52:30",
					inputString = "9 2/5 * * * *",
					nextOccurence = "01/01/2003 00:57:09",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
					startTime = "01/01/2003 00:57:30",
					inputString = "9 2/5 * * * *",
					nextOccurence = "01/01/2003 01:02:09",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				new
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "10  * 22    * *",
					nextOccurence = "22/01/2003 00:10:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "30 23 19    * *",
					nextOccurence = "19/01/2003 23:30:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:00:00",
					inputString = "30 23 21    * *",
					nextOccurence = "21/01/2003 23:30:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "01/01/2003 00:01:00",
					inputString = " *  * 21    * *",
					nextOccurence = "21/01/2003 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "10/07/2003 00:00:00",
					inputString = " *  * 30,31 * *",
					nextOccurence = "30/07/2003 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				new
				{
					...
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/01/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/01/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/01/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/01/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/01/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/01/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/02/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/02/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/03/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/03/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/03/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/03/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/03/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/03/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/04/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/04/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/04/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/04/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/05/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/05/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/05/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/05/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/05/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/05/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/06/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					...
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/06/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/06/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/07/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/07/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/07/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/07/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/07/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/07/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/08/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/08/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/08/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/08/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/08/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/08/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/09/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/09/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/09/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/09/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/10/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/10/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/10/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/10/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/10/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/10/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/11/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/11/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/11/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/11/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/12/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "15/12/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "30/12/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "30/12/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "31/12/2000 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "31/12/2000 00:00:00",
					inputString = "0 0 15,30,31 * *",
					nextOccurence = "15/01/2001 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				new
				{
					startTime = "01/07/2002 05:00:00",
					inputString = "10 * * February,April-Jun *",
					nextOccurence = "01/02/2003 00:10:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				new
				{
					startTime = "11/03/1988 14:23:00",
					inputString = "* 2,4-8,15 * 6 *",
					nextOccurence = "01/06/1988 02:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "11/03/1988 14:23:00",
					inputString = "20 * * january,FeB,Mar,april,May,JuNE,July,Augu,SEPT-October,Nov,DECEM *",
					nextOccurence = "11/03/1988 15:20:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
					startTime = "11/09/1988 14:23:00",
					inputString = "* 12 1 6 * 1988,1989",
					nextOccurence = "01/06/1989 12:00:00",
					cronStringFormat = CronStringFormat.WithYears
				},
				new
				{
					startTime = "11/09/1988 14:23:00",
					inputString = "* 12 1 6 * 1988,2000",
					nextOccurence = "01/06/2000 12:00:00",
					cronStringFormat = CronStringFormat.WithYears
				},
				new
				{
					startTime = "11/09/1988 14:23:00",
					inputString = "* 12 1 6 * 1988/5",
					nextOccurence = "01/06/1993 12:00:00",
					cronStringFormat = CronStringFormat.WithYears
				},
				...
				new
				{
					startTime = "26/06/2003 10:00:00",
					inputString = "30 6 * * sunday",
					nextOccurence = "29/06/2003 06:30:00",
					cronStringFormat = CronStringFormat.Default
				},
				new
				{
				...
				new
				{
					startTime = "01/09/2003 23:45:00",
					inputString = "45 16 * * Mon#2",
					nextOccurence = "08/09/2003 16:45:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				new
				{
					startTime = "01/01/2003 23:45:00",
					inputString = "0 0 * * SUNDAYL",
					nextOccurence = "26/01/2003 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				{
					startTime = "01/01/2003 23:45:00",
					inputString = "0 0 * * SATURDAYL",
					nextOccurence = "25/01/2003 00:00:00",
					cronStringFormat = CronStringFormat.Default
				},
				...
				new
				{
					startTime = "29/02/2004 12:01:00",
					inputString = "1 12 29 2 * */3",
					nextOccurence = "29/02/2016 12:01:00",
					cronStringFormat = CronStringFormat.WithYears
				},
				new
				{
					startTime = "29/02/2004 12:01:00",
					inputString = "1 12 29 2 * 2005/3",
					nextOccurence = "29/02/2008 12:01:00",
					cronStringFormat = CronStringFormat.WithYears
				},
				new
				{
					startTime = "29/02/2004 12:01:00",
					inputString = "1 12 29 2 * 2002/7",
					nextOccurence = "29/02/2016 12:01:00",
					cronStringFormat = CronStringFormat.WithYears
				},
			...
			foreach (var test in tests) _CronCall(test.startTime, test.inputString, test.nextOccurence, test.cronStringFormat);
		}
		...
		public void EvaluationsBlank()
		{
			var tests = new[]
			{
				...
				new
				{
					startTime = "22/05/1983 00:00:00",
					inputString = "0 0 12 * * ?",
					nextOccurence = "22/05/1983 12:00:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				new
				{
					startTime = "22/05/1983 00:00:00",
					inputString = "0 15 10 ? * *",
					nextOccurence = "22/05/1983 10:15:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				new
				{
				...
				{
					startTime = "22/05/1983 00:00:00",
					inputString = "0 10,44 14 ? 3 WED",
					nextOccurence = "07/03/1984 14:10:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				{
					startTime = "22/05/1983 00:00:00",
					inputString = "0 15 10 L * ?",
					nextOccurence = "31/05/1983 10:15:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				new
				{
					startTime = "01/07/1984 00:00:00",
					inputString = "0 15 10 ? * 6L",
					nextOccurence = "28/07/1984 10:15:00",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				{
					startTime = "01/07/1984 00:00:00",
					inputString = "39 26 13 ? * 5L 2002-2005",
					nextOccurence = "25/01/2002 13:26:39",
					cronStringFormat = CronStringFormat.WithSecondsAndYears
				},
				...
				new
				{
					startTime = "01/06/2016 00:00:00",
					inputString = "1 16 11 ? * 6#3",
					nextOccurence = "18/06/2016 11:16:01",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				{
					startTime = "01/07/1984 00:00:00",
					inputString = "1 2 12 1/5 * ?",
					nextOccurence = "01/07/1984 12:02:01",
					cronStringFormat = CronStringFormat.WithSeconds
				},
				...
				{
					startTime = "01/07/1984 00:00:00",
					inputString = "0 11 11 11 11 ?",
					nextOccurence = "11/11/1984 11:11:00",
					cronStringFormat = CronStringFormat.WithSeconds
				}
			};
		...
		public void FiniteOccurrences()
		{
			...
			foreach (var test in tests) _CronFinite(test.inputString, test.startTime, test.endTime, test.cronStringFormat);
		}
		...
		{
			_BadField("* * 31 Feb *", CronStringFormat.Default);
			_BadField("* * * 31 Feb *", CronStringFormat.WithSeconds);
			_BadField("* * 31 Feb * *", CronStringFormat.WithYears);
			_BadField("* * * 31 Feb * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * 30-31 Feb *", CronStringFormat.Default);
		}

		[TestMethod]
		private static void _BadField(string expression, CronStringFormat format)
		{
		...
		{
			_BadField("bad * * * * *", CronStringFormat.Default);
		}
		...
		{
			_BadField("bad * * * *", CronStringFormat.Default);
			_BadField("* bad * * * *", CronStringFormat.WithSeconds);
		}
		...
		{
			_BadField("* * * * mon,bad,wed", CronStringFormat.Default);
			_BadField("* * * * * mon,bad,wed", CronStringFormat.WithSeconds);
		}

		[TestMethod]
		public void OutOfRangeField()
		{
			_BadField("* 1,2,3,456,7,8,9 * * *", CronStringFormat.Default);
			_BadField("* * 1,2,3,456,7,8,9 * * *", CronStringFormat.WithSeconds);
		}

		[TestMethod]
		public void BadYearField()
		{
			_BadField("* * * * * Bad", CronStringFormat.WithYears);
			_BadField("* * * * * * Bad", CronStringFormat.WithSecondsAndYears);
		}

		[TestMethod]
		public void NonNumberValueInNumericOnlyField()
		{
			_BadField("* 1,Z,3,4 * * *", CronStringFormat.Default);
			_BadField("* * 1,Z,3,4 * * *", CronStringFormat.WithSeconds);
		}

		[TestMethod]
		public void BadDayOfWeekStringParsing()
		{
			_BadField("Mon * * * * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* Mon * * * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * Mon * * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * * Mon * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * * * Mon * *", CronStringFormat.WithSecondsAndYears);
		...
		{
			_BadField("Oct * * * * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* Oct * * * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * Oct * * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * * Oct * * *", CronStringFormat.WithSecondsAndYears);
			_BadField("* * * * * Oct *", CronStringFormat.WithSecondsAndYears);
		...
		{
			_BadField("* 1/Z * * *", CronStringFormat.Default);
			_BadField("* * 1/Z * * *", CronStringFormat.WithSeconds);
		}

		[TestMethod]
		public void NonNumericFieldRangeComponent()
		{
			_BadField("* 3-l2 * * *", CronStringFormat.Default);
			_BadField("* * 3-l2 * * *", CronStringFormat.WithSeconds);
		}
		...
		public void MultipleInstancesTest()
		{
			...
			for (var i = 0; i < 10; i++) newInput = parser.GetNextOccurrence(newInput);
		...
		public void NoNextInstanceTest()
		{
			...
			Assert.IsFalse(stopWatch.ElapsedMilliseconds > 250,
				string.Format("Elapsed time should not exceed 250ms (was {0} ms)", stopWatch.ElapsedMilliseconds));
		}

		private static void _CronCall(string startTimeString, string cronExpression, string nextTimeString,
			CronStringFormat format)
		{
			var schedule = CrontabSchedule.Parse(cronExpression, format);
			var next = schedule.GetNextOccurrence(_Time(startTimeString));

			var message = string.Format("Occurrence of <{0}> after <{1}>, format <{2}>.", cronExpression, startTimeString,
				Enum.GetName(typeof(CronStringFormat), format));
		...
		private static void _CronFinite(string cronExpression, string startTimeString, string endTimeString,CronStringFormat format)
		{
			...
			Assert.AreEqual(endTimeString, _TimeString(occurrence),
				"Occurrence of <{0}> after <{1}> did not terminate with <{2}>.",
				cronExpression, startTimeString, endTimeString);
		}

		private static string _TimeString(DateTime time) { return time.ToString(_TIME_FORMAT, CultureInfo.InvariantCulture); }

		private static DateTime _Time(string str) { return DateTime.ParseExact(str, _TIME_FORMAT, CultureInfo.InvariantCulture); }
	}
}
